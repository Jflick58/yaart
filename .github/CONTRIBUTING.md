# Contributing to yaart

Hi there! Thank you for even being interested in contributing to yaart.
...
Our [issues](https://github.com/jflick58/yaart/issues) page is kept up to date
...
As of now, yaart has an ad hoc release process: releases are cut with high frequency by
a developer and published to [PyPI](https://pypi.org/project/yaart/).

yaart follows the [semver](https://semver.org/) versioning standard. However, as pre-1.0 software,
